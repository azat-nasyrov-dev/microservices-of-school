...
describe('UserController', () => {
  ...
  beforeAll(async () => {
    ...
    const { access_token } = await rmqService
  ...
  it('AccountUserInfo', async () => {
    const res = await rmqService
      .triggerRoute<AccountUserInfo.Request, AccountUserInfo.Response>(
  ...
  it('BuyCourse', async () => {
    ...
    const res = await rmqService
      .triggerRoute<AccountBuyCourse.Request, AccountBuyCourse.Response>(
  ...
  it('PaymentCheck', async () => {
    ...
    const res = await rmqService
      .triggerRoute<AccountCheckPayment.Request, AccountCheckPayment.Response>(
